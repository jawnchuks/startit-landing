        ...
        <div className="py-16 md:py-24 lg:py-32">
          <div className="mx-auto max-w-xl bg-[#f2f2f7] px-5 py-12 text-center md:px-10 relative">
            ...
            <p className="mx-auto mb-5 mt-4 max-w-xl text-[#647084] md:mb-8">
              Be among the first to embark on a journey of limitless
              opportunities, whether you&apos;re eager to invest, collaborate on
              projects, or initiate groundbreaking ventures.
            </p>
            ...
            >
              ...
              <div className="relative mb-4 pb-2">
                ...
                >
                  ...
                  <option value="I want to initiate a project">
                ...
                <span className="h-4 w-4 flex-none">
                  {loading ? (
                    <>
                      <svg
                        aria-hidden="true"
                        className="w-4 h-4 text-primaryGreen animate-spin  fill-primaryWhite"
                        viewBox="0 0 100 101"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                      >
